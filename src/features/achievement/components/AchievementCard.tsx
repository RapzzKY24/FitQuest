...
import { claimBadgeAction } from "../actions/actions";
...
export const AchievementCard = ({
  ...
  const handleClaim = async () => {
    // Lu bisa tambahin efek suara atau confetti di sini 🎉
    const result = await claimBadgeAction(achievement.id);
    if (result.success) {
      showToast({
        type: "success",
        title: "Berhasil",
        message: "Badge Berhasil Di Klaim!",
      });
    }
  };
    ...
    <section>
      ...
      >
        ...
        <div className="w-full mt-6">
          {/* 👇 Tambahin kondisi || claimable di sini */}
        ...
        <CardFooter className="w-full mt-4 p-0 z-10">
          <Button
            onClick={handleClaim}
